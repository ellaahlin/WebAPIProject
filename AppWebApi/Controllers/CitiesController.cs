...
namespace AppWebApi.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        ILogger<CitiesController> _logger = null;
            ...
            string filter = null, string pageNr = "0", string pageSize = "1000")
        {
            ...
            var items = await _service.ReadCitiesAsync(_usr, _seeded, _flat, filter?.Trim()?.ToLower(), _pageNr, _pageSize);
            return Ok(items);
        }
        ...
        public async Task<IActionResult> ReadItem(string id = null, string flat = "false")
        {
            ...
            var item = await _service.ReadCityAsync(_usr, _id, _flat);
            if (item == null)
            {
        ...
        public async Task<IActionResult> DeleteItem(string id)
        {
            ...
            try
            {
                var _item = await _service.DeleteCityAsync(_usr, _id);
        ...
        [ProducesResponseType(200, Type = typeof(csCityCUdto))]
        [ProducesResponseType(400, Type = typeof(string))]
        [ProducesResponseType(404, Type = typeof(string))]
        public async Task<IActionResult> ReadItemDto(string id = null)
        {
            ...
            var item = await _service.ReadCityAsync(_usr, _id, false);
            if (item == null)
            {
                return NotFound($"item {_id} not found");
            }

            var dto = new csCityCUdto(item);
            return Ok(dto);
        }
        ...
        [ProducesResponseType(200, Type = typeof(csCityCUdto))]
        [ProducesResponseType(400, Type = typeof(string))]
        public async Task<IActionResult> UpdateItem(string id, [FromBody] csCityCUdto item)
        {
            //Convert and check parameters
            Guid _id = Guid.Empty;
            if (!Guid.TryParse(id, out _id))
            ...
            try
            {
                var _item = await _service.UpdateCityAsync(_usr, item);
        ...
        [ProducesResponseType(200, Type = typeof(csCityCUdto))]
        [ProducesResponseType(400, Type = typeof(string))]
        public async Task<IActionResult> CreateItem([FromBody] csCityCUdto item)
        {
            try
            {
                var _item = await _service.CreateCityAsync(_usr, item);
                _logger.LogInformation($"item {_item.CityID} created");
        ...
        #region constructors
        public CitiesController(IAttractionService attractionService, ILogger<CitiesController> logger)
        {
